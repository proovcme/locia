...
**Locia — открытая витрина и self-hosted набор инструментов для проектной организации.** Он объединяет управление проектами в проектировании, работу с IFC-моделями и расчёт стоимости проектных работ.
