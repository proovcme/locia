...
[Открыть «Атлас»](https://locia.work/atlas/) · [Исходники и сборка](apps/atlas/)
...
[Открыть «Калькулятор»](https://locia.work/pircalc/) · [Исходники и сборка](apps/pircalc/)
...
[Открыть «PDF-редактор»](https://locia.work/pdf-editor/) · [Исходники и запуск](apps/pdf-editor/)
...
В репозитории находятся исходники всех четырёх инструментов, готовые браузерные сборки «Атласа» и «Калькулятора», конфигурация контейнеров и документация для самостоятельного размещения. Актуальная самостоятельная «Лемма» — в [отдельном репозитории](https://github.com/proovcme/lemma).
...
```text
apps/lemma/       прежняя комплексная поставка PHP-приложения
apps/atlas/       TypeScript-исходники и сборка публичного IFC viewer
apps/pircalc/     React/TypeScript-исходники публичного калькулятора
